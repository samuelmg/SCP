...
//<= $quin
	...
	echo ("<table id='info' border='1' width='70%'><thead><tr> <th>Proyecto</th> <th>Recibido</th> <th>Cheques</th> <th>Requisiciones</th> <th>Reembolsos</th> <th>Transferencias</th> <th>Saldo</th> <th>Monto Quin > ".$lim_quin."</th> <th>Devolución</th> </tr></thead><tbody align='right'>");
	$sum_disp=0;
	$sum_ch=0;
	$sum_req=0;
	$sum_ing=0;
	...
	for ($j=0; $j<$reg; $j++){
		...
		$sum_excluye+=$excluye[$j];//Sumatoria Exclusión
		$sum_dev+=$dev[$j];
