...
echo ("</table>");
echo ("<hr />Este reporte fué creado en base al diseño original del Ing. Rafael Martinez a quien agradezco su constante voluntad por compartir sus conocimientos");
}
?>
</body>
</html>