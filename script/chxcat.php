...
echo ("<table id='info' align='center' border='1'><thead><tr><th colspan='7'>Cheques en Tr�nsito</th></tr><tr> <th>Cta Bancaria</th> <th>Cheque</th> <th>Fecha</th> <th>Beneficiario</th> <th>Monto</th> <th>Proyecto</th> <th>Cuenta</th> </tr></thead><tbody>");
...
echo ("<table id='info' align='center' border='1'><thead><tr><th colspan='10'>Relaci�n de Cheques con Estatus ".$estatus."</th></tr> <tr> <th>Cta Bancaria</th> <th>Cheque</th> <th>Fecha</th> <th>Beneficiario</th> <th>Monto</th> <th>Proyecto</th> <th>Cuenta</th> <th>Estatus</th> <th>Seguimiento</th> <th>Responsable</th> </tr></thead><tbody>");
$renglon='non';//cambio de color en renglones
...
function ch_comp($res, $seleccion){//Cheques en proceso de comprobaci�n
...
echo ("<table id='info' align='center' border='1'><thead><tr><th colspan='11'>Cheques en Proceso de Comprobaci�n</th></tr><tr> <th>Cta Bancaria</th> <th>Cheque</th> <th>Fecha</th> <th>Beneficiario</th> <th>Monto</th> <th>Proyecto</th> <th>Cuenta</th> <th>Estatus</th> <th>Seguimiento</th> <th>Responsable</th> <th>Fecha de Recibido</th> </tr></thead><tbody>");
$renglon='non';//cambio de color en renglones
...
$sql_fin = "select ch.cta_b, ch.cheque, ch.fecha, ben.benef, ch.monto, ch.proy, ch.cta, ch.oficio, ch.responsable, ch.fecha_c from tbl_cheques ch, tbl_benef ben, tbl_proyectos p where ch.benef_id=ben.benef_id and ch.proy=p.proy and (oficio!='' and oficio is not null) and p.ures $seleccion order by ch.cta_b, ch.cheque";
$qry_fin = mysql_query($sql_fin);

echo ("<table id='info' border='1'><thead><tr> <th>Cta Bancaria</th> <th>Cheque</th> <th>Fecha</th> <th>Beneficiario</th> <th>Monto</th> <th>Proyecto</th> <th>Cuenta</th> <th>Oficio</th> <th>Responsable</th> <th>Fecha Comp</th> </tr></thead><tbody>");
while ($arr_fin = mysql_fetch_array($qry_fin)){
	echo ("<tr> <td align='center'>".$arr_fin['cta_b']."</td> <td align='center'>".$arr_fin['cheque']."</td> <td>".$arr_fin['fecha']."</td> <td>".utf8_decode($arr_fin['benef'])."</td> <td align='right'>".number_format($arr_fin['monto'],2)."</td> <td>".$arr_fin['proy']."</td> <td>".$arr_fin['cta']."</td> <td>".$arr_fin['oficio']."</td> <td>".$arr_fin['responsable']."</td> <td>".$arr_fin['fecha_c']."</td> </tr>");
