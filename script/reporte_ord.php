...
echo("<table border ='1'><thead><tr><th>U Res</th><th>Descripción URes</th><th>Proyecto</th><th>Nombre del Proyecto</th><th>Monto Autorizado</th> <th>Quincena Disponible</th></tr></thead> <tbody align='center'><tr><td>".$arr_proy['ures']."</td> <td>".utf8_decode($arr_proy['d_ures'])."</td> <td>".$arr_proy['proy']."</td> <td>".utf8_decode($arr_proy['d_proy'])."</td> <td>".number_format($arr_proy['monto'],2)."</td> <td>".$arr_proy['quin']."</td> </tr></tbody></table>");
