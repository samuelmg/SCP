...
conect_usr();
chxp($proy);
echo ("<p><form align='center' action='chxp_1b.php' method='post'> <input type='hidden' value='$proy' name='proy' /><button type='submit' name='ordenar'>Ordenar x Cuenta (OG)</button></form></p>");
?>
<div id="nota">
